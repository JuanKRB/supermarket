...
<html lang="en">
    ...
    <body>
        <div class="botonAtras">
            <a href="usuario.jsp" ><img src="img/atras.png" alt=""/></a>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="col-7">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input type="text" class="form-control" value="daniel oviedo">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input type="email" class="form-control" value="daniel@gmail.com">
                                </div>
                            </div>
